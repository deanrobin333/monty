...
/**
 * strtow - separates words from a string
 * @str: string to perform separation
 ...
 * @delims: Pointer to null terminated array containing delimitors
...
/**
 * get_word_count - gets the word count in a string
...
/**
 * get_next_word - gets the next word of a string
